...
<div align="center">
	<form method="get" >
		...
		<input type="text" name="search" value="${search}" size="70">
    ...
    <table border="1" cellpadding="5" cellspacing="5">
        ...
        <tr>
        	<c:if test="${currentPage != 1}">
        		<th><a href="users?<c:if test="${not empty search}">search=${search}&</c:if>page=${currentPage - 1}"><i class="fa fa-chevron-left" aria-hidden="true"></i></a></th>
    		</c:if>
            <c:forEach begin="1" end="${noOfPages}" var="i">
                <c:choose>
                    ...
                    <c:otherwise>
                        <td><a href="users?<c:if test="${not empty search}">search=${search}&</c:if>page=${i}">${i}</a></td>
                    </c:otherwise>
                </c:choose>
            </c:forEach>
        
        	<c:if test="${currentPage lt noOfPages}">
        		<th><a href="users?<c:if test="${not empty search}">search=${search}&</c:if>page=${currentPage + 1}"><i class="fa fa-chevron-right" aria-hidden="true"></i></a></th>
    		</c:if>
    	</tr>
    </table>
